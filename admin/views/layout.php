...
<head>
    ...
    <!--external css-->
    <link href="assets/font-awesome/public/css/font-awesome.css" rel="stylesheet" />
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="index.php">Danh sách tin tức</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="themtintuc.php">Thêm loại tin</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
